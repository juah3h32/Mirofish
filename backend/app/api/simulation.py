...
def get_graph_entities(graph_id: str):
    ...
    try:
        ...
        current_app.logger.error(f"Error in get_graph_entities: {e}", exc_info=True)
        return jsonify({
            "success": False,
...
def get_entity_detail(graph_id: str, entity_uuid: str):
    ...
    try:
        ...
        current_app.logger.error(f"Error in get_entity_detail: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
...
def get_entities_by_type(graph_id: str, entity_type: str):
    ...
    try:
        ...
        current_app.logger.error(f"Error in get_entities_by_type: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
...
def create_simulation():
    ...
    try:
        ...
        current_app.logger.error(f"Error in create_simulation: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
...
def prepare_simulation():
    ...
    try:
        ...
        current_app.logger.error(f"Error in prepare_simulation: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
...
def get_simulation(simulation_id: str):
    ...
    try:
        ...
        current_app.logger.error(f"Error in get_simulation: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
...
def list_simulations():
    ...
    try:
        ...
        current_app.logger.error(f"Error in list_simulations: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
...
def get_simulation_history():
    ...
    try:
        ...
        current_app.logger.error(f"Error in get_simulation_history: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
...
def get_simulation_profiles(simulation_id: str):
    ...
    try:
        ...
        current_app.logger.error(f"Error in get_simulation_profiles: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
...
def get_simulation_profiles_realtime(simulation_id: str):
    ...
    try:
        ...
        current_app.logger.error(f"Error in get_simulation_profiles_realtime: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
...
def get_simulation_config_realtime(simulation_id: str):
    ...
    try:
        ...
        current_app.logger.error(f"Error in get_simulation_config_realtime: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
...
def get_simulation_config(simulation_id: str):
    ...
    try:
        ...
        current_app.logger.error(f"Error in get_simulation_config: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
...
def download_simulation_config(simulation_id: str):
    ...
    try:
        ...
        current_app.logger.error(f"Error in download_simulation_config: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
...
def download_simulation_script(script_name: str):
    ...
    try:
        ...
        current_app.logger.error(f"Error in download_simulation_script: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
...
def generate_profiles():
    ...
    try:
        ...
        current_app.logger.error(f"Error in generate_profiles: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
...
def start_simulation():
    ...
    try:
        ...
        current_app.logger.error(f"Error in start_simulation: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
...
def stop_simulation():
    ...
    try:
        ...
        current_app.logger.error(f"Error in stop_simulation: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
...
def get_run_status(simulation_id: str):
    ...
    try:
        ...
        current_app.logger.error(f"Error in get_run_status: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
...
def get_run_status_detail(simulation_id: str):
    ...
    try:
        ...
        current_app.logger.error(f"Error in get_run_status_detail: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
...
def get_simulation_actions(simulation_id: str):
    ...
    try:
        ...
        current_app.logger.error(f"Error in get_simulation_actions: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
...
def get_simulation_timeline(simulation_id: str):
    ...
    try:
        ...
        current_app.logger.error(f"Error in get_simulation_timeline: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
...
def get_agent_stats(simulation_id: str):
    ...
    try:
        ...
        current_app.logger.error(f"Error in get_agent_stats: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
...
def get_simulation_posts(simulation_id: str):
    ...
    try:
        ...
        current_app.logger.error(f"Error in get_simulation_posts: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
...
def get_simulation_comments(simulation_id: str):
    ...
    try:
        ...
        current_app.logger.error(f"Error in get_simulation_comments: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
...
def interview_agent():
    ...
    try:
        ...
        current_app.logger.error(f"Error in interview_agent: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
...
def interview_agents_batch():
    ...
    try:
        ...
        current_app.logger.error(f"Error in interview_agents_batch: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
...
def interview_all_agents():
    ...
    try:
        ...
        current_app.logger.error(f"Error in interview_all_agents: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
...
def get_interview_history():
    ...
    try:
        ...
        current_app.logger.error(f"Error in get_interview_history: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
...
def get_env_status():
    ...
    try:
        ...
        current_app.logger.error(f"Error in get_env_status: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
...
def close_simulation_env():
    ...
    try:
        ...
        current_app.logger.error(f"Error in close_simulation_env: {e}", exc_info=True)
        return jsonify({
            "success": False,
            "error": 'Error interno del servidor'
        }), 500
